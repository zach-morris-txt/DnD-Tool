...
//API Endpoints
apiRoute.get("/users/:id", async (req, res) => {
    const { id } = req.params
...
apiRoute.get("/organisations", async (req, res) => {
    const userId = req.userId
    let record = await db.query(`
        SELECT 
...
apiRoute.post("/organisations", async (req, res) => {
    const userId = req.userId
...
apiRoute.post("/organisations/:orgId/users", async (req, res) => {
...
apiRoute.get("/organisations/:orgId", async (req, res) => {
    // const userId = req.userId
    const { orgId } = req.params
